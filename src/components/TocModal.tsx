        ...
        <section className="modal-body">
          ...
          <div className="modal-toolbar">
            <button
              type="button"
              className="button"
              onClick={() => addTocEntry(currentPage, variant)}
              disabled={busy}
            >
              Add Entry
            </button>
              ...
              >
                <label className="toc-field">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateTocEntry(index, { ...entry, title: event.target.value }, variant)
                    }
                    disabled={busy}
                  />
                </label>
                  ...
                  <label className="toc-field toc-level">
                    ...
                    <select
                      ...
                      onChange={(event) => {
                        ...
                        updateTocEntry(index, { ...entry, level }, variant);
                      }}
                      disabled={busy}
                    >
                ...
                <label className="toc-field toc-page">
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      ...
                      updateTocEntry(index, { ...entry, page: clamped }, variant);
                    }}
                    disabled={busy}
                  />
                </label>
                <button
                  ...
                  onClick={() => generateChapterText(index)}
                ...
                <button
                  ...
                  onClick={() => removeTocEntry(index, variant)}
                  disabled={busy}
                >
                  Remove
                </button>
